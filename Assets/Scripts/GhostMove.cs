...
// 10 8";
    ...
    private Vector3 getStartPosAccordingToName()
    {
        ...
        switch (gameObject.name)
        {
			...
			// case "covidr":
   //              return new Vector3(15f, 24f, 0f);

            case "blinky":
                return new Vector3(15f, 20f, 0f);

            case "covidr_1":
                return new Vector3(12f, 20f, 0f);
            case "covidr_2":
                return new Vector3(14f, 18f, 0f);
            case "covidr_3":
                return new Vector3(16f, 16.5f, 0f);

            
			case "covidb":
                return new Vector3(15f, 20f, 0f);
            case "covidb_1":
                return new Vector3(10f, 20f, 0f);
            case "covidb_2":
                return new Vector3(16f, 18f, 0f);
            case "covidb_3":
                return new Vector3(12.5f, 16.5f, 0f);
